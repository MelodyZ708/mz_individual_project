...
run_experiment() {
    ...
    local NUM_CH="$4"
    local STEP="$5"
    local FULL_CH_COUNT="$6"  # conv1/layer1=64, layer2=128
...
# [6]→[6,28]→[6,28,34]→[6,28,34,62]*→[6,28,34,62,12]→
# [6,28,34,62,12,54]→[6,28,34,62,12,54,3]
# * most cost-effective at step 4 (Width reaches upper limit)
# ════════════════════════════════════════════════════════════
echo "=================================================="
echo "CONV1 POST-RELU Ablation (Beam1, seed=Ch06, 7 steps)"
echo "Most cost-effective: Step 4 [6,28,34,62]"
echo "=================================================="
...
# [2]→[2,61]→[2,61,60]→[2,61,60,32]→[2,61,60,32,53]*→[2,61,60,32,53,41]
# * most cost-effective at step 5
# ════════════════════════════════════════════════════════════
echo "=================================================="
echo "LAYER1 POST-RELU Ablation (Beam1, seed=Ch02, 6 steps)"
echo "Most cost-effective: Step 5 [2,61,60,32,53]"
echo "=================================================="
...
# [120]→[120,66]→[120,66,39]*
# * global optimum at step 3
# ════════════════════════════════════════════════════════════
echo "=================================================="
echo "LAYER2 POST-RELU Ablation (Beam1, seed=Ch120, 3 steps)"
echo "Global optimum: Step 3 [120,66,39]"
echo "=================================================="
...
# ════════════════════════════════════════════════════════════
echo "=================================================="
echo "ABLATION SUMMARY (Post-ReLU, all layers):"
echo "=================================================="
column -t -s $'\t' "${SUMMARY}"
echo ""
