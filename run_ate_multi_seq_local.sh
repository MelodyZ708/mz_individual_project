#!/bin/bash
# ──────────────────────────────────────────────────────────────
# Multi-Sequence ATE Evaluation — Local Lab Version
# Configs: gray | coarse_only | fine_only | c2f_a | c2f_b | c2f_c
# Datasets: fr2/desk, fr3/long_office (clean + flashlight + lightswitch)
# ──────────────────────────────────────────────────────────────

echo "=========================================="
echo "Multi-Sequence ATE Evaluation (Local)"
...
run_one() {
    ...
    # Run COMO (no Xvfb needed on local machine with display)
