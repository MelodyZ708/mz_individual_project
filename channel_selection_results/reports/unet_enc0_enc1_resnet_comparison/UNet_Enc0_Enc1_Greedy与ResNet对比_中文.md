...
| 3 | [d3,d7,d12] | 6.0004 | 关键跃迁；相对 d3 降低 75.5% |
...
全 16 通道为 12.9502 cm，而最优六通道为 5.9208 cm，误差降低 **54.3%**。早期 BQS top-5 控制组 [d0,d3,d10,d14,d15] 为 13.7216 cm，也说明“按代理挑出的高分 channel”不等同于完整序列最优组合。
...
最终六通道相对于 Enc1 直接 greedy 的 G6 [d0,d5,d6,d17,d18,d30]（6.9553 cm）再降低 **3.2%**。同时，它相对于 all-32 的 18.9322 cm 降低 **64.4%**，相对于早期 BQS top-5 控制组的 18.4940 cm 降低 **63.6%**。
...
| 比较项 | Enc0 | Enc1 | 结论 |
|---|---:|---:|---|
| 最优 4-channel ATE mean | 6.3905 cm | 7.1673 cm | Enc0 低 **10.8%** |
| 最优 6-channel ATE mean | 5.9208 cm | 6.7335 cm | Enc0 低 **12.1%** |
...
|---|---|---:|---:|---:|
| U-Net Enc0 best-4 | [d2,d3,d12,d14] | 4 | **6.3905** | 低 **54.6%** |
| U-Net Enc1 best-4 | [d0,d5,d18,d30] | 4 | **7.1673** | 低 **49.0%** |
...
若比较不受四通道约束的最终结果，Enc0 K=6 为 5.9208 cm、Enc1 K=6 为 6.7335 cm，分别比 ResNet 当前四通道冠军低 **57.9%** 与 **52.1%**。这是一项强的同序列结果，但还不能推出 U-Net 在不同照明、模糊、遮挡或跨数据集上都优于 ResNet；后续应以当前 ResNet best-4 和 balanced-4 作为并列对照做多序列验证。
