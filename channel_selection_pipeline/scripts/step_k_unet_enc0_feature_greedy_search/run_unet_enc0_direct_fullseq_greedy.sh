#!/usr/bin/env bash
# Safe launcher for the resumable UNet enc0 full-sequence greedy search.
...
EVALUATOR="$SCRIPT_DIR/run_unet_enc0_direct_fullseq_greedy.py"
OUTPUT_DIR="$PROJECT_ROOT/channel_selection_results/step_k_unet_enc0_direct_fullseq_greedy"
...
printf '%s\n' '=============================================================================='
printf '%s\n' 'UNET ENC0 DIRECT FULL-SEQUENCE GREEDY SEARCH'
printf '%s\n' '=============================================================================='
printf '[PLAN] Full fr1/desk_lightswitch; enc0 has 16 full-resolution channels\n'
