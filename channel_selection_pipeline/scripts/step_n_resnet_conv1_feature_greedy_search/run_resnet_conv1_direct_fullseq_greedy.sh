#!/usr/bin/env bash
# Safe launcher for the resumable ResNet Conv1 full-sequence greedy search.
...
EVALUATOR="$SCRIPT_DIR/run_resnet_conv1_direct_fullseq_greedy.py"
OUTPUT_DIR="$PROJECT_ROOT/channel_selection_results/step_n_resnet_conv1_direct_fullseq_greedy"
...
printf '%s\n' '=============================================================================='
printf '%s\n' 'RESNET CONV1 (PROJECT CONV0) DIRECT FULL-SEQUENCE GREEDY SEARCH'
printf '%s\n' '=============================================================================='
printf '[PLAN] Full fr1/desk_lightswitch only; maximum six selected post-ReLU Conv1 channels\n'
